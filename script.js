const games = [
    ...
    { title: "No Mans Sky", url: "games/nms/index.html", description: "Explore the galaxy. 🎮 Controls: W/S (Thrust), A/D (Turn), Space (Boost), F (Shoot), L (Land), G (Map), I (Station), U (Upgrade)" },
    ...
    { title: "Subway Runner", url: "games/subway/index.html", description: "Ultimate 3D running action! 🎮 Use Arrow Keys." },
